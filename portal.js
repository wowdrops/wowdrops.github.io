...
function executeCancelOrder() {
  ...
  callBackendAPI("cancelCustomerOrder", { cpn: activeUserSession.cpn }, 
    function(response) {
      closeCancelModal();
...
function processOrderSubmission() {
  ...
  var payload = { cpnno: activeUserSession.cpn, ordD: dVal, ordE: eVal, olderDues: activeUserSession.older };
